...
try {
    CustomKeywords.'com.FormFillDay4.fillFirstName'(firstName)

    CustomKeywords.'com.FormFillDay4.fillGender'(gender)

    CustomKeywords.'com.FormFillDay4.fillGamePlayed'()

    CustomKeywords.'com.FormFillDay4.CheckTCBtn'()
