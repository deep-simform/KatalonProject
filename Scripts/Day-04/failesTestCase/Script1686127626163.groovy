...
WebUI.click(findTestObject('Object Repository/Day-01/Practice Form Demo QA/Page_DEMOQA/inputsafgasdf	klh;fjsad_Date of Birth_dateOfBirthInput'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Day-01/Practice Form Demasdasdasdo QA/Page_DEMOQA/td_Male'), 'Male')
...
WebUI.verifyElementText(findTestObject('Object Repository/Day-01/Practice Form Demo QA/Pagasdasdasde_DEMOQA/td_Simform_Wallpaper4.png'), 
